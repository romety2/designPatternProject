...
public class FuneralHomeMournful extends FuneralHome
{
	@Override
	protected Coffin createCoffin(String type)
	{
		Coffin c = null;
		WreathFactory f = WreathMournfulFactory.getInstance();
		...
		{ 
			c = new CoffinDecorator(new TombstoneAdapter(new Tombstone(f)));
